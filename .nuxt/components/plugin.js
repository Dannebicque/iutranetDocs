...
const components = {
  ...
  AppPageBottom: () => import('../../node_modules/@nuxt/content-theme-docs/src/components/app/AppPageBottom.vue' /* webpackChunkName: "components/app-page-bottom" */).then(c => wrapFunctional(c.default || c)),
